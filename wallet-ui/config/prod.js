...
//ChainId和资产ID
export const MAIN_INFO = {chainId: 3, assetId: 1};
//运行模式（true:electron窗体模式，false:浏览器模式）
export const RUN_PATTERN = false;
//桌面程序下载路径（main：http://samos.io/download  test：http://samos.io/download/test ）background.js package 手动修改
export const FILE_URL = 'http://samos.io/download';
//正式、测试网络的api
...
const electronData = [
  ...
  },
  {
    ...
    decimals: 8,
    chainName: RUN_DEV ? 'SAMO' : 'tSAMO',
    urls: RUN_DEV ? 'https://public1.yqkkn.com' : 'https://public1.yqkkn.com',
    delay: '10ms',
    selection: false,
    isDelete: false
  }
...
const explorerData = [
  ...
  },
  {
    ...
    decimals: 8,
    chainName: RUN_DEV ? 'SAMO' : 'tSAMO',
    urls: RUN_DEV ? 'https://public1.yqkkn.com' : 'http://public1.yqkkn.com',
    delay: '10ms',
    selection: false,
    isDelete: false
  }
